...
import {  Grid, FormControlLabel, Checkbox, IconButton, MenuItem, TextField, InputLabel, Typography, Divider, Input, Link, Stepper, Step, StepLabel, Box } from '@mui/material';
...
export function CadastroAgremiacao() {
    ...
    const handleRoutes = () => {
        ...
        const valuesToPost = { ...formik.values, Documentos: [...currentFileToCreate], anotacoes: notes };
    ...
    const { isLoading, mutate } = useMutation(
        () => handleRoutes(),
        {
            onSuccess: () => {
                ...
                const successMsg = id ? 'Agremiação editada com sucesso!' : 'Agremiação cadastrada com sucesso!';
                emitAlertMessage("success", successMsg);
                navigate('/agremiacao');
            },
            onError: () => {
                const errorMsg = id ? 'Erro ao editar agremiação' : 'Erro ao cadastrar agremiação';
    ...
    return (
        <form onSubmit={formik.handleSubmit} encType="multipart/form-data" autoComplete='off' >
            ...
            <div id="cadastro" style={{marginTop: id!== undefined ? 40 : 0}}>
                                    ...
                                    onChange={(e) => {
                                        ...
                                        fileReader.onload = () => {
                                            if (fileReader.readyState === 2) {
                                                if (fileReader.result === null || typeof fileReader.result !== 'string') return;
                        ...
                        <Grid container spacing={2} sx={{width: '600px', }}>
                            ...
                            <Grid item xs={4}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    error={formik.touched['dataFiliacao'] && Boolean(formik.errors['dataFiliacao'])}
                                    helperText={formik.touched['dataFiliacao'] && formik.errors['dataFiliacao']}
                                    size='small'
                                    fullWidth
                                    InputLabelProps={{
                                        shrink: true
                            ...
                            <Grid item xs={12}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    error={formik.touched['fantasia'] && Boolean(formik.errors['fantasia'])}
                                    helperText={formik.touched['fantasia'] && formik.errors['fantasia']}
                                    size='small'
                                    fullWidth
                                    InputLabelProps={{
                                        shrink: true
                            ...
                            <Grid item xs={4}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    error={formik.touched['idRegiao'] && Boolean(formik.errors['idRegiao'])}
                                    helperText={formik.touched['idRegiao'] && formik.errors['idRegiao']}
                                    size='small'
                                    fullWidth
                                    InputLabelProps={{
                                        shrink: true
                        ...
                        <Grid container spacing={2} sx={{width: '800px'}}>
                            ...
                            <Grid item xs={4}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    error={formik.touched['idEstado'] && Boolean(formik.errors['idEstado'])}
                                    helperText={formik.touched['idEstado'] && formik.errors['idEstado']}
                        ...
                        <Grid container spacing={2} sx={{width: '800px'}}>
                            ...
                            <Grid item xs={3}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    error={formik.touched['dataCnpj'] && Boolean(formik.errors['dataCnpj'])}
                                    helperText={formik.touched['dataCnpj'] && formik.errors['dataCnpj']}
                                    size='small'
                                    fullWidth
                                    InputLabelProps={{
                                        shrink: true
                            ...
                            <Grid item xs={3}>
                                <TextField
                                    ...
                                    onChange={formik.handleChange}
                                    onBlur={formik.handleBlur}
                                    error={formik.touched['dataAta'] && Boolean(formik.errors['dataAta'])}
                                    helperText={formik.touched['dataAta'] && formik.errors['dataAta']}
                                    size='small'
                                    fullWidth
                                    InputLabelProps={{
                                        shrink: true
